    ...
    <style>
        * {
        ...
        .log-entry {
            ...
            display: grid;
            grid-template-columns: 150px 80px 120px 300px 1fr;
            gap: 15px;
            align-items: center;
        }
...
<body>
    <div class="container">
        ...
        <div class="controls">
            <input type="text" class="search-box" id="searchBox" placeholder="Search in network logs...">
            <div class="filters">
        ...
        <div class="footer">
            <p>TestAutomation_with_DevTools - Network Monitoring Report</p>
        </div>
    </div>
