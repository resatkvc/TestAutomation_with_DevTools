    ...
    <div class="container">
        ...
        <div class="stats">
            <div class="stat-card">
                ...
                <div class="stat-label">Console Entries</div>
            </div>
            <div class="stat-card">
        ...
        <div class="controls">
            <input type="text" class="search-box" id="searchBox" placeholder="Search in console logs...">
            <div class="filters">
        ...
        <div class="log-container" id="logContainer">
            <#list logEntries as entry>
                <div class="log-entry ${entry.levelClass}" data-level="${entry.level?lower_case}">
                    ...
                    <div class="source">${entry.logger}</div>
        ...
        <div class="footer">
            <p>TestAutomation_with_DevTools - Console Log Report</p>
        </div>
    </div>
