...
<body>
    <div class="container">
        ...
        <div class="controls">
            <input type="text" class="search-box" id="searchBox" placeholder="Search in logs...">
            <div class="filters">
        ...
        <div class="log-container" id="logContainer">
            <#list logEntries as entry>
                <div class="log-entry ${entry.levelClass}" data-level="${entry.level?lower_case}">
                    ...
                    <div class="logger">${entry.logger}</div>
        ...
        <div class="footer">
            <p>TestAutomation_with_DevTools - HTML Report Generator</p>
        </div>
    </div>
